...
function faq_sets(): array
{
    return [
        ...
        'integration-guide' => [
            ...
            ['Which product should I integrate first?', 'The one that matches how you get paid: the Payment Gateway for checkout, Payment Links to get paid without a checkout, Smart Collections for recurring or scheduled payments, and Payouts to send money out.'],
