...
function pc_pages(): array
{
    ...
    return [
        ...
        'wallet-infrastructure' => [
            ...
            'description' => 'Wallet infrastructure explained for platforms in India: what a wallet is, how RBI regulates prepaid payment instruments, the difference between accepting wallets and running one, and what Paynancial publishes today.',
            'h1'    => 'Wallets on your platform — what it takes, and where to start.',
            'lead'  => 'Wallet infrastructure lets a platform hold and show a balance for each user. In India that is a regulated activity. Here is what it involves, and what Paynancial publishes today.',
            'answer' => 'Wallet infrastructure lets a platform hold a stored balance for each of its users. In India, wallets are prepaid payment instruments (PPIs), which the Reserve Bank of India regulates — issuing one needs RBI authorisation or a partnership with an authorised issuer. Paynancial does not describe wallet infrastructure on this site; what it publishes is accepting wallets as a payment method at checkout.',
            'values' => ['Explained for India', 'RBI PPI rules', 'Accept vs issue', 'Talk to our team'],
            ...
            'what' => [
                ...
                'Running a wallet is a regulated activity in India, and it changes how money flows through your product. Many platforms find that what they actually need is simpler: a record of what each user is owed, settled by <a class="inline-link" href="/products/embedded-payouts">payouts</a>. Talk to our team before you design around a stored balance.',
            ],
            'steps' => [
                ['Define the need', 'Decide whether users need a spendable balance, or just a record of what they are owed.'],
                ['Check the regulation', 'Understand the RBI rules for prepaid payment instruments.'],
                ['Choose the issuer', 'A wallet is issued by an RBI-authorised entity, directly or in partnership.'],
                ['Plan KYC', 'Wallet limits depend on how fully each user is verified.'],
        ...
        'split-payments' => [
            ...
            'description' => 'Split payments for marketplaces in India: how one customer payment is shared between a platform and its sellers, how RBI rules shape it, and what Paynancial publishes today — collect, then pay sellers and partners through Payouts.',
            ...
            'confirm' => ['Splitting at the point of collection', 'Whether your model counts as payment aggregation under RBI rules', 'Holding funds until an order is fulfilled', 'Settlement timing for each party'],
            'what' => [
        ...
        'white-label-payments' => [
            ...
            'steps' => [
                ...
                ['Check the rules', 'Understand who is the regulated party in front of merchants.'],
