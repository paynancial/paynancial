    ...
    return [
        'accept-and-collect' => [
            ...
            'items' => [
                ...
                ['Recurring Payments', 'page', '/products/recurring-payments', 'Instalments and repeat charges collected on the schedule you set, with retries and per-cycle reconciliation.'],
                ['Subscription Billing', 'page', '/products/subscription-billing', 'Subscription fees collected every cycle, failed renewals retried and every renewal reconciled.'],
        ...
        'embedded-finance' => [
            ...
            'items' => [
                ['Embedded Payments', 'guide', '/products/embedded-payments', 'Take payments inside your own product with the Payment API and a custom checkout.'],
                ['Embedded Payouts', 'guide', '/products/embedded-payouts', 'Pay your platform\'s sellers, creators and partners from your own systems through Payouts.'],
                ['Embedded Billing', 'guide', '/products/embedded-billing', 'Recurring and scheduled billing inside your software with the Collections API.'],
                ['Wallet Infrastructure', 'guide', '/products/wallet-infrastructure', 'What running a wallet involves in India, and how it differs from accepting wallets.'],
                ['Split Payments', 'guide', '/products/split-payments', 'Share one customer payment between a marketplace and its sellers: collect, then pay out.'],
                ['White-Label Payments', 'guide', '/products/white-label-payments', 'Keep payments in your own brand with a custom checkout and partner programmes.'],
            ],
