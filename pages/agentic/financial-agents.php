...
<?php sp_band_open('capabilities', 'dim'); ?>
  ...
  <?php sp_table(['Pattern', 'What the agent does', 'What stays with people', 'Related capability'], [
      ...
      ['Exception handling', 'Routes a failed payment, disputed charge or mismatched invoice to the right next step instead of a shared queue.', 'Handling the cases that need judgement.', '<a class="inline-link" href="/products/payment-collection">Smart Collections</a>'],
