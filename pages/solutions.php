...
$industries = [
    ...
    'healthcare'            => ['Healthcare', 'Secure, compliant billing flows for clinics and hospitals.', 'A clinic uses Smart Collections to bill patients for recurring treatment plans and reconcile insurance co-payments.'],
    'education'             => ['Education', 'Simplify fee collection for schools, colleges and training institutes.', 'A training institute uses Smart Collections to automate monthly fee billing across hundreds of students.'],
    ...
    'logistics'             => ['Logistics & Transportation', 'Collect on delivery and pay fleet partners without manual reconciliation.', 'A logistics operator uses Smart Collections for cash-on-delivery orders and Payouts to settle with drivers weekly.'],
